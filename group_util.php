...
if (isset($_POST['enregistrer']))
{
    ...
    $gu = $bdd->query('SELECT * FROM groupe_utilisateur WHERE libelle_groupe_utilisateur="'.$_POST['libelle_groupe_utilisateur'].'" OR id_groupe_utilisateur="'.$_POST['identifiant'].'"')   ;
    if ($res = $gu->fetch())
    {
        ?>
    ...
    {
        $bdd->query("INSERT INTO groupe_utilisateur (id_groupe_utilisateur,libelle_groupe_utilisateur) VALUES ('$_POST[identifiant]', '$_POST[libelle_groupe_utilisateur]')")   ;
        ?>
...
$gu = $bdd->query("SELECT * FROM groupe_utilisateur ORDER BY id_groupe_utilisateur ASC ")   ;
