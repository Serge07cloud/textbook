<div class="card shadow mb-4">
    <div class="card-header py-3">
        <center><h4 style="text-align: left" class="m-0 font-weight-bold text-primary"> AUTORISATION D'INSCRIPTION - AVIS PAR LE DIRECTEUR UF</h4></center>
    </div>
</div>
<form action="" method="post">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <center><h5 style="text-align: left" class="m-0 font-weight-bold text-primary">STRUCTURE D'ACCUEIL</h5></center>
        </div>
        <div class="card-body">
            <div class="form-row">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <center><h5 style="text-align: left" class="m-0 font-weight-bold text-primary">SOUHAIT ETUDIANT</h5></center>
        </div>
        <div class="card-body">
            <div class="form-row">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <center><h5 style="text-align: left" class="m-0 font-weight-bold text-primary">IDENTITE ETUDIANT</h5></center>
        </div>
        <div class="card-body">
            <div class="form-row">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <center><h5 style="text-align: left" class="m-0 font-weight-bold text-primary">INFORMATION CURSUS ETUDIANT ANNEE ACADEMIQUE N-1</h5></center>
        </div>
        <div class="card-body">
            <div class="form-row">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <center><h5 style="text-align: left" class="m-0 font-weight-bold text-primary">AVIS RESPONSABLE UF</h5></center>
        </div>
        <div class="card-body">
            <div class="form-row">
...
<form action="" method="post">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 style="text-align: left" class="m-0 font-weight-bold text-primary">Liste des demandes</h6>
        </div>
        <div class="card-body">
            <div>
                <table class="table table-bordered" width="74px">
                    <tbody>
                    <tr>
                        <th>NDemande</th>
                        <th>Date Demande</th>
